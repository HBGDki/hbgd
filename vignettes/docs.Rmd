...
vignette: >
  %\VignetteIndexEntry{hbgd documentation}
...
```{r fit_face_wand, cache=FALSE}
wandfit <- get_fit(smc, y_var = "haz", method = "wand")
```
```{r fit_face2, cache=TRUE}
...
```{r fit5c, echo=TRUE, cache=TRUE, message=FALSE}
...
```{r smocc_holdout2, cache=TRUE, warning=FALSE}
...
```{r smocc_holdout3, cache=TRUE, message=FALSE}
